...
from policies.cnn_features import ConnectXCNNExtractor
...
def train_against_opponents(main_ckpt: str, failed_opponents: List[Tuple[str, str]], 
    ...
    # CNN backbone with moderate MLP heads
    model = PPO(
        "MlpPolicy",
        env,
        ...
        policy_kwargs=dict(
            features_extractor_class=ConnectXCNNExtractor,
            features_extractor_kwargs={"features_dim": 512, "hidden_channels": (64,128,128)},
